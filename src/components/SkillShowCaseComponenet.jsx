...
const skills = [
  {
    ...
    color:
      "from-blue-600/90 to-blue-700/90 dark:from-blue-400/90 dark:to-blue-500/90",
  },
  {
    id: "Tailwind CSS",
    name: "Tailwind CSS",
    ...
    color:
      "from-cyan-600/90 to-teal-600/90 dark:from-cyan-400/90 dark:to-teal-400/90",
  },
  {
    id: "JavaScript",
    name: "JavaScript",
    ...
    color:
      "from-yellow-600/90 to-orange-600/90 dark:from-yellow-400/90 dark:to-orange-400/90",
  },
  {
    id: "Node.js",
    name: "Node.js",
    ...
    color:
      "from-green-600/90 to-emerald-600/90 dark:from-green-400/90 dark:to-emerald-400/90",
  },
  {
    id: "MongoDB",
    name: "MongoDB",
    ...
    color:
      "from-green-700/90 to-green-800/90 dark:from-green-500/90 dark:to-green-600/90",
  },
  {
    id: "Socket.IO",
    name: "Socket.IO",
    ...
    color:
      "from-purple-600/90 to-violet-600/90 dark:from-purple-400/90 dark:to-violet-400/90",
  },
  {
    id: "Express.js",
    name: "Express.js",
    ...
    color:
      "from-slate-600/90 to-slate-700/90 dark:from-slate-500/90 dark:to-slate-600/90",
  },
  {
    id: "Python",
    name: "Python",
    icon: FaPython, // replace with a Python logo if you want
    level: 65,
    description:
      "Skilled in Python for scripting and problem-solving, with experience in data handling using Pandas.",
    color:
      "from-yellow-500/90 to-yellow-600/90 dark:from-yellow-400/90 dark:to-yellow-500/90",
  },
];
  ...
  return (
    <motion.div
      ...
      className={`group relative w-full overflow-hidden rounded-2xl bg-gray-100/60 dark:bg-slate-800/60 backdrop-blur-sm border border-gray-300/50 dark:border-slate-700/50 p-4 sm:p-6 cursor-pointer transition-all duration-300 hover:bg-gray-200/80 dark:hover:bg-slate-800/80 hover:border-gray-400/60 dark:hover:border-slate-600/60 hover:shadow-lg hover:shadow-gray-500/20 dark:hover:shadow-slate-900/20 ${
        isSelected
          ? "ring-2 ring-blue-400/50 bg-gray-200/80 dark:bg-slate-800/80 border-gray-400/60 dark:border-slate-600/60"
          : ""
      }`}
    >
      {/* Background gradient overlay */}
      <div
        className={`absolute inset-0 bg-gradient-to-br ${skill.color} opacity-10 dark:opacity-5 group-hover:opacity-20 dark:group-hover:opacity-10 transition-opacity duration-300`}
      />
      ...
      <div className="relative w-48 h-48 sm:w-56 sm:h-56">
        ...
        >
          ...
          <motion.circle
            ...
            animate={{
              strokeDashoffset: level > 0 ? strokeDashoffset : circumference,
            }}
            transition={{
              duration: 1.5,
              delay: 0.5,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            />
            <span className="text-gray-700 dark:text-slate-300 text-sm sm:text-base font-medium">
          ...
          >
            Explore my technical skills and proficiency levels. Tap on any
            technology card to see detailed expertise metrics and real-time
            visualizations.
          </motion.p>
        </motion.div>
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-slate-400 text-sm leading-relaxed">
                    Select any technology card to view detailed proficiency
                    metrics and expertise analysis
                  </p>
                </div>
              </motion.div>
            )}
